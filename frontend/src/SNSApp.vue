...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: 'FindManage', 
                description: 'FindManage을 관리하는 화면입니다.', 
                key: 'findManages', 
                route: '/finds/findManages',
                ImageUrl: '',
            },
            { 
                title: 'RemoteManage', 
                description: 'RemoteManage을 관리하는 화면입니다.', 
                key: 'remoteManages', 
                route: '/lostPhones/remoteManages',
                ImageUrl: '',
            },
            { 
                title: 'Phone', 
                ...
                key: 'phones', 
                route: '/lostPhones/phones',
                ImageUrl: '',
            },
            { 
                title: 'CustomerManage', 
                description: 'CustomerManage을 관리하는 화면입니다.', 
                key: 'customerManages', 
                route: '/kts/customerManages',
                ImageUrl: '',
            },
            { 
                title: 'DeviceManage', 
                description: 'DeviceManage을 관리하는 화면입니다.', 
                key: 'deviceManages', 
                route: '/kts/deviceManages',
                ImageUrl: '',
            },
            { 
                title: 'View', 
