...
pluralCaseList.push( {plural: "finds/findManages", pascal: "FindFindManage"} )

pluralCaseList.push( {plural: "lostPhones/remoteManages", pascal: "LostPhoneRemoteManage"} )
pluralCaseList.push( {plural: "lostPhones/phones", pascal: "LostPhonePhone"} )

pluralCaseList.push( {plural: "kts/customerManages", pascal: "KtCustomerManage"} )
pluralCaseList.push( {plural: "kts/deviceManages", pascal: "KtDeviceManage"} )
